...
public class DocumentTree
{
      ...
      XTextDocument doc)
  {
    ...
    while (textPortionEnu.hasMoreElements())
    {
      ...
      else if (textPortionType.equals("Text"))
      {
        ...
        if (textRange != null) textPortions.add(new TextRangeNode(textRange));
      }
      else
  ...
  public static class InsertionBookmarkNode extends WollmuxBookmarkNode implements
      InsertionBookmark
  {
  ...
  public static class CheckboxNode extends Node implements FormControl
  {
    ...
    public String getDescriptor()
    {
      ...
      try
      {
        buffy.append((String) UNO.getProperty(model, "HelpText"));
      }
      catch (Exception x)
      {}
      ;
      if (buffy.toString().trim().length() < 2) try
      {
        buffy.append(UNO.XNamed(model).getName());
      }
      catch (Exception x)
      {}
      ;
  ...
  public static class DropdownNode extends TextFieldNode implements
      DropdownFormControl
  {
    ...
    public String getDescriptor()
    {
      ...
      try
      {
        buffy.append((String) UNO.getProperty(textfield, "Name"));
      }
      catch (Exception x)
      {}
      ;
  ...
  public static class InputNode extends TextFieldNode implements FormControl
  {
    ...
    public String getDescriptor()
    {
      ...
      try
      {
        buffy.append((String) UNO.getProperty(textfield, "Hint"));
      }
      catch (Exception x)
      {}
      ;
      if (buffy.toString().trim().length() < 2) try
      {
        buffy.append((String) UNO.getProperty(textfield, "Content"));
      }
      catch (Exception x)
      {}
      ;
