...
public class WollMuxEventListener 
{
	  ...
	  @Subscribe
	  public void onShowDialogPersoenlicheAbsenderlisteVerwalten(OnShowDialogPersoenlicheAbsenderlisteVerwalten event)
	  {
	    event.process();
	  }
	  
	  @Subscribe
	  public void onShowDialogAbsenderAuswaehlen(OnShowDialogAbsenderAuswaehlen event)
	  {
	    event.process();
	  }
	  ...
	  @Subscribe
	  public void onRemovePALChangeEventListener(OnRemovePALChangeEventListener event)
	  {
	    event.process();
	  }
	  ...
	  @Subscribe
	  public void onButtonZuleitungszeilePressed(OnButtonZuleitungszeilePressed event)
	  {
	    event.process();
	  }
