...
public class OnAbout extends BasicEvent
{
	...
	protected void doit() throws WollMuxFehlerException
	{
		...
		JLabel label = new JLabel(
		    L.m("WollMux") + " " + WollMuxSingleton.getVersion());
		...
		authorPanelHBox.setBorder(
		    BorderFactory.createTitledBorder(L.m("Autoren (sortiert nach LOC)")));
		...
		infoPanel.add(
		    new JLabel(L.m("WollMux") + " " + WollMuxSingleton.getBuildInfo()));

		if (wollMuxBarVersion != null && !wollMuxBarVersion.equals(""))
			infoPanel
			    .add(new JLabel(L.m("WollMux-Leiste") + " " + wollMuxBarVersion));
