...
public class IfThenElseDialog extends TrafoDialog
{
  ...
  public IfThenElseDialog(TrafoDialogParameters params)
  {
    ...
    ifThenElsePanel =
      new JIfThenElsePanel(params.conf, params.fieldNames,
  ...
  private static class JIfThenElsePanel extends JPanel
  {
     ...
     */
    private void buildConditionalResultGUI(final List<String> fieldNames,
        final JComponent guiContainer, String label,
        final ConditionalResult conditionalResult)
    {
      ...
      AbstractButton textRadioButton =
      ...
      controls.add(Box.createHorizontalGlue());
      AbstractButton ifThenElseRadioButton =
          ...
          if (conditionalResult.type != 1)
          {
            ...
            if (conditionalResult.panel == null)
            {
              ...
              try
              {
                ...
                conditionalResult.panel =
                  new JIfThenElsePanel(conf, fieldNames, packNecessary);
        ...
        List<String> fieldNames)
    {
      try
      {
          ...
          && (conf.getName().equals("THEN") || conf.getName().equals("ELSE")))
        {
          ...
          {
            res.type = 1; // ACHTUNG! neue JIfThenElsePanels werden noch anderswo
            // instanziiert
