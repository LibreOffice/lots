  ...
  private void search()
  {
    ...
    try
    {
      if (count == 1)
      {
        ...
        {
          /*
           * 1 Wort kein Sternchen enthalten Email Email@muenchen.de Nachn* Abteilung
           * *eilung Vorname Vorn*
           */
          do
          {
      ...
      else if (count == 2)
      {
        ...
        // if (!hasComma)
        {
          ...
          {
            /*
             * 2 Worte, kein Komma kein Sternchen Vorname Nachname Nachname Vorname
             * Vorname Nachn* Nachname Vorn* Abt-eilung Abt/eilung Abt<space>eilung
             * Abt_eilung *t-eilung *t/eilung *t<space>eilung *t_eilung Vorn* Nachn*
             * Nachn* Vorn*
             */
            out: do
            {
      ...
      else if (count > 2)
      {
         ...
         * 
         * Ganzer String wird wieder zusammengebaut und als Abteilung interpretiert
         * kein Sternchen Abteilung (z.B. KVR-II/213 Team 1) *bteilung
         * 
