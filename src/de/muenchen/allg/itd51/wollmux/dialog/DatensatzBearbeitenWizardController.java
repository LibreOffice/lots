...
public class DatensatzBearbeitenWizardController implements XWizardController
{
  ...
  private int selectedAnredeIndex = 0;
  ...
  public boolean confirmFinish()
  {
    ...
    case PERSON:
      ...
      try
      {
        XTextComponent rolle = UNO.XTextComponent(controlContainer.getControl("txtRolle"));
        XComboBox anrede = UNO.XComboBox(controlContainer.getControl("cbAnrede"));
        ...
        dataset.set("Anrede", anrede.getItem((short) selectedAnredeIndex));
        ...
        dataset.set("DienstBezLang", dienstBezLang.getText());
  ...
  public XWizardPage createPage(XWindow arg0, short arg1)
  {
    ...
    try
    {
      ...
      case PERSON:
        ...
        XControlContainer controlContainerPerson = UnoRuntime
            .queryInterface(XControlContainer.class, page.getWindow());
        UNO.XTextComponent(controlContainerPerson.getControl("txtRolle"))
            .setText(dataset.get("Rolle"));

        XComboBox anredeComboBox = UNO.XComboBox(controlContainerPerson.getControl("cbAnrede"));
        ...
        anredeComboBox.addItemListener(anredeItemListener);

        UNO.XTextComponent(controlContainerPerson.getControl("txtEmail"))
            .setText(dataset.get("Mail"));
        UNO.XTextComponent(controlContainerPerson.getControl("txtVorname"))
            .setText(dataset.get("Vorname"));
        UNO.XTextComponent(controlContainerPerson.getControl("txtNachname"))
            .setText(dataset.get("Nachname"));
        UNO.XTextComponent(controlContainerPerson.getControl("txtTitel"))
            .setText(dataset.get("Titel"));
        UNO.XTextComponent(controlContainerPerson.getControl("txtTel"))
            .setText(dataset.get("Telefon"));
        UNO.XTextComponent(controlContainerPerson.getControl("txtFax")).setText(dataset.get("Fax"));
        UNO.XTextComponent(controlContainerPerson.getControl("txtZimmerNr"))
            .setText(dataset.get("Zimmer"));
        UNO.XTextComponent(controlContainerPerson.getControl("txtStr"))
            .setText(dataset.get("Postanschrift"));
        UNO.XTextComponent(controlContainerPerson.getControl("txtDienstgebPLZ"))
            .setText(dataset.get("PostPLZ"));
        UNO.XTextComponent(controlContainerPerson.getControl("txtDienstgebOrt"))
            .setText(dataset.get("PostOrt"));
        UNO.XTextComponent(controlContainerPerson.getControl("txtZustaendigkeit"))
            .setText(dataset.get("Zustaendigkeit"));
        UNO.XTextComponent(controlContainerPerson.getControl("txtFunktion"))
            .setText(dataset.get("Funktion"));
        UNO.XTextComponent(controlContainerPerson.getControl("txtDienstBezKurz"))
            .setText(dataset.get("DienstBezKurz"));
        UNO.XTextComponent(controlContainerPerson.getControl("txtDienstBezLang"))
            .setText(dataset.get("DienstBezLang"));
      ...
      case ORGA:
        ...
        XControlContainer controlContainerOrga = UnoRuntime.queryInterface(XControlContainer.class,
            page.getWindow());
        UNO.XTextComponent(controlContainerOrga.getControl("txtReferat"))
            .setText(dataset.get("Referat"));
        UNO.XTextComponent(controlContainerOrga.getControl("txtOrgaKurz"))
            .setText(dataset.get("OrgaKurz"));
        UNO.XTextComponent(controlContainerOrga.getControl("txtOrgaLang"))
            .setText(dataset.get("OrgaLang"));
        UNO.XTextComponent(controlContainerOrga.getControl("txtDienststelle"))
            .setText(dataset.get("OrgaName"));
        UNO.XTextComponent(controlContainerOrga.getControl("txtStr"))
            .setText(dataset.get("Dienstgebaeude"));
        UNO.XTextComponent(controlContainerOrga.getControl("txtPLZ"))
            .setText(dataset.get("DienstgebaeudePLZ"));
        UNO.XTextComponent(controlContainerOrga.getControl("txtOrt"))
            .setText(dataset.get("DienstgebaeudeOrt"));
        UNO.XTextComponent(controlContainerOrga.getControl("txtEMail"))
            .setText(dataset.get("OrgaEmail"));
        UNO.XTextComponent(controlContainerOrga.getControl("txtTelefon"))
            .setText(dataset.get("OrgaTelefon"));
        UNO.XTextComponent(controlContainerOrga.getControl("txtFax"))
            .setText(dataset.get("OrgaFax"));
      ...
      case FUSSZEILE:
        ...
        XControlContainer controlContainerFusszeile = UnoRuntime
            .queryInterface(XControlContainer.class, page.getWindow());
        UNO.XTextComponent(controlContainerFusszeile.getControl("txtSpalte1Teil1"))
            .setText(dataset.get("FussSpalte1"));
        UNO.XTextComponent(controlContainerFusszeile.getControl("txtSpalte1Teil2"))
            .setText(dataset.get("FussSpalte12"));
        UNO.XTextComponent(controlContainerFusszeile.getControl("txtSpalte2Teil1"))
            .setText(dataset.get("FussSpalte2"));
        UNO.XTextComponent(controlContainerFusszeile.getControl("txtSpalte2Teil2"))
            .setText(dataset.get("FussSpalte22"));
        UNO.XTextComponent(controlContainerFusszeile.getControl("txtSpalte3Teil1"))
            .setText(dataset.get("FussSpalte3"));
        UNO.XTextComponent(controlContainerFusszeile.getControl("txtSpalte3Teil2"))
            .setText(dataset.get("FussSpalte32"));
        UNO.XTextComponent(controlContainerFusszeile.getControl("txtSpalte4Teil1"))
            .setText(dataset.get("FussSpalte4"));
        UNO.XTextComponent(controlContainerFusszeile.getControl("txtSpalte4Teil2"))
            .setText(dataset.get("FussSpalte42"));
  ...
  private AbstractItemListener anredeItemListener = new AbstractItemListener()
  {

    @Override
    public void itemStateChanged(ItemEvent arg0)
    {
      selectedAnredeIndex = arg0.Selected;
    }
  };
}
