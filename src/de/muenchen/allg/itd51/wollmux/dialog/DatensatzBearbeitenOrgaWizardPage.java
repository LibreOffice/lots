...
public class DatensatzBearbeitenOrgaWizardPage implements XWizardPage
{
  ...
  public DatensatzBearbeitenOrgaWizardPage(XWindow parentWindow, short pageId) throws Exception
  {
    this.pageId = pageId;
    ...
    try
    {
      resultUrl = UNO.convertFilePathToURL("/home/bjr/Downloads/DatensatzBearbeitenOrga.xdl");
