...
public class DatensatzBearbeitenPersonWizardPage implements XWizardPage
{
  ...
  public DatensatzBearbeitenPersonWizardPage(XWindow parentWindow, short pageId) throws Exception
  {
    this.pageId = pageId;
    ...
    try
    {
      resultUrl = UNO.convertFilePathToURL("/home/bjr/Downloads/DatensatzBearbeitenPerson.xdl");
