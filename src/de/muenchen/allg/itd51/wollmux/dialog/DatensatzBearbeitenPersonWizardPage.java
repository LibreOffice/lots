...
public class DatensatzBearbeitenPersonWizardPage extends AbstractXWizardPage
{
  ...
  public DatensatzBearbeitenPersonWizardPage(XWindow parentWindow, short pageId) 
  {
    ...
    resultUrl = UNO.convertFilePathToURL("/home/aero/Downloads/DatensatzBearbeitenPerson.xdl");
