...
public class FormularGuiSidebarPanel extends ComponentBase implements XUIElement
{
  private String resourceUrl;
  private XToolPanel panel;

  public FormularGuiSidebarPanel(XComponentContext context, XWindow parentWindow,
      String resourceUrl)
  {
    this.resourceUrl = resourceUrl;
    panel = new FormularGuiSidebarContent(context, parentWindow);
  }
