...
public class TextDocumentModel
{
  ...
  public XStyle createParagraphStyle(String name, String parentStyleName)
  {
    ...
    if (pss != null)
    {
      try
      {
        XStyle style = UNO.XStyle(
            UNO.XMultiServiceFactory(doc).createInstance("com.sun.star.style.ParagraphStyle"));
  ...
  public XStyle createCharacterStyle(String name, String parentStyleName)
  {
    ...
    if (pss != null)
    {
      ...
      {
        XStyle style = UNO.XStyle(
            UNO.XMultiServiceFactory(doc).createInstance("com.sun.star.style.CharacterStyle"));
        pss.insertByName(name, style);
        if (style != null && parentStyleName != null)
          style.setParentStyle(parentStyleName);
        return UNO.XStyle(pss.getByName(name));
