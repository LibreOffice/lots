...
WollMux Bar - external controller for the WollMux form letter extension for OpenOffice.org Writer
...
WollMux is an extension to Openoffice.org Writer with the following features:
