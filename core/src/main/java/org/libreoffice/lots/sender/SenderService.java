...
import org.libreoffice.lots.db.DummyDatasourceWithMessagebox;
...
import org.libreoffice.lots.sender.dialog.PersoenlicheAbsenderlisteVerwalten;
...
public class SenderService implements XPALProvider
{
  ...
  public long searchDefaultSender()
  {
    ...
    try
    {
      ...
      ConfigThingy strat = wmConf.query("PersonalSenderListInit").query("SearchStrategy")
          .getLastChild();
  ...
  public void showManageSenderListDialog()
  {
    ...
    {
      LOGGER.error(e.getMessage(), e);
      InfoDialog.showInfoModal("Update failed", L.m("Personal sender list could not be updated."));
    }
  }
