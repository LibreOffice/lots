...
import org.libreoffice.lots.document.commands.DocumentCommand.Form;
...
import org.libreoffice.lots.document.commands.DocumentCommand.InsertValue;
import org.libreoffice.lots.document.commands.DocumentCommand.InvalidCommand;
import org.libreoffice.lots.document.commands.DocumentCommand.OverrideFrag;
import org.libreoffice.lots.document.commands.DocumentCommand.SetGroups;
import org.libreoffice.lots.document.commands.DocumentCommand.SetJumpMark;
...
public abstract class AbstractExecutor implements DocumentCommand.Executor
{
  ...
  public static void insertErrorField(DocumentCommand cmd, XTextDocument doc, java.lang.Exception e)
  {
    ...
    if (insCursor == null)
    {
      LOGGER.error("Cannot insert error field because InsertCursor could not be created.");
      return;
