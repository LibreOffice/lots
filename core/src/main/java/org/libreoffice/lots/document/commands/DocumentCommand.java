...
public abstract class DocumentCommand
{
   ...
   *
   * @see org.libreoffice.lots.document.VisibilityElement#getAnchor()
   */
   ...
   * @see org.libreoffice.lots.document.VisibilityElement#isVisible()
   */
   ...
   * @see org.libreoffice.lots.document.VisibilityElement#setVisible(boolean)
   */
