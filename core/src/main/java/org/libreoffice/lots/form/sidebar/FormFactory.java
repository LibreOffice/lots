...
public class FormFactory extends AbstractSidebarFactory
{
  ...
  public static final String SERVICE_NAME = "org.libreoffice.lots.form.sidebar.FormFactory";
      ...
      throws NoSuchElementException
  {
    ...
    return new FormSidebarController(resourceUrl, context, parentWindow, model).getFormSidebarPanel();
  }
}
