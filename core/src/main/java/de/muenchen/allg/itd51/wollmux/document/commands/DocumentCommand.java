...
public abstract class DocumentCommand
{
   ...
   *
   * @see de.muenchen.allg.itd51.wollmux.document.VisibilityElement#getAnchor()
   */
   ...
   * @see de.muenchen.allg.itd51.wollmux.document.VisibilityElement#isVisible()
   */
   ...
   * @see de.muenchen.allg.itd51.wollmux.document.VisibilityElement#setVisible(boolean)
   */
