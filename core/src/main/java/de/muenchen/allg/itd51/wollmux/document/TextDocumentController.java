...
public class TextDocumentController
{
  ...
  public String getTransformedValue(String trafoName, String value)
  {
    ...
    if (trafoName != null)
    {
      ...
      {
        transformed = L.m("<ERROR: TRAFO '%1' not defined>", trafoName);
  ...
  private String getTransformedValue(String trafoName, Map<String, String> mapIdToValues)
  {
    ...
    {
      LOGGER.error(L.m("ERROR: TRAFO '%1' not defined.", trafoName));
      return L.m("<ERROR: TRAFO '%1' is not defined>", trafoName);
    }
  }
